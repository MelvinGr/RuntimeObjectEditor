...
namespace RuntimeObjectEditor.PropertyGrid.Tabs.Fields
{
    ...
    {
        public override Bitmap Bitmap => Resources.Fields;

        public override string TabName => "All Fields";
        ...
        {
            var propsCollection = PropertyDescriptorUtils.GetAllFields(context, component, attributes);
