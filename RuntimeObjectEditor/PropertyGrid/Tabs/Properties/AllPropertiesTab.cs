...
namespace RuntimeObjectEditor.PropertyGrid.Tabs.Properties
{
    /// <summary>
    ...
    {
        public override Bitmap Bitmap => Resources.CustomProperties;

        public override string TabName => "All Properties";
